...
<body bgcolor=black>
<p align=center>
<img src="https://i.ibb.co/P6dtgq7/i-crew.png" alt="ICREW"  width="20%" /></p>
<p align="center"><font color="red" size="5">ICREW ADMIN FINDER</font></p>
<form method="POST" action="<?php $PHP_SELF; ?>">
<p align="center"><font color="yellow">Enter Website : </font>
<input type="text" name="url" value="http://"/>
<br>
<input type="submit" name="submit" value="F*ck it"/>
</p>
<br>
<br>
<?php
//This code was created the developer kid
...
#this code is re-coded by icrew dev.wing